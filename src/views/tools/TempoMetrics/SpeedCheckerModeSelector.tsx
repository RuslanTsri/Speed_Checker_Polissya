...
export default function SpeedCheckerModeSelector({ onBack, onSelect, onOpenBluetooth }: any) {
    ...
    return (
        <View className="flex-1 pt-4 relative">
            ...
            <View className="px-4">
                ...
                <ModeCard title={t('tools.speed_checker.quick_test_title')} subtitle={t('tools.speed_checker.quick_test_desc')} Icon={StartIcon} ActiveIcon={StartIconActive} onPress={() => onSelect('DEVICE', 'QUICK')} />
                <ModeCard title={t('tools.speed_checker.team_test_title')} subtitle={t('tools.speed_checker.team_test_desc')} Icon={TeamsIcon} ActiveIcon={TeamsIconActive} onPress={() => onSelect('DEVICE', 'TEAM')} />
            </View>
        </View>
    );
}
